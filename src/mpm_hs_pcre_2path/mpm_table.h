...
typedef struct MpmTableElmt_ {
    ...
    int (*AddPattern)(MpmCtx *, uint8_t *, uint16_t, uint16_t, uint16_t, uint32_t, SigIntId, uint32_t);
    int (*AddPatternNocase)(MpmCtx *, uint8_t *, uint16_t, uint16_t, uint16_t, uint32_t, SigIntId, uint32_t);
